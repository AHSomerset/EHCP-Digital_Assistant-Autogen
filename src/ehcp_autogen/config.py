...
STRENGTHS_GUIDE = os.path.join(_PARTIALS_DIR, "_s3_strengths_guide.md")
...
def get_section_config(section_number: str) -> dict:
    ...
    path_map = {
        ...
        "2": {
            "writer_guidance": [writer_guidance_s, WRITER_COMMON_RULES, STRUCTURE_S2, STYLE_GUIDE_S2],
        ...
        "3": {
            ...
            "source_exclude_files": ['Appendix A']
        },
    }
